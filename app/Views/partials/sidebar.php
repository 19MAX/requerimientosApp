<div id="miniSidebar" style="height: 2264.94px;">
    <div class="brand-logo">
        <a class="d-none d-md-flex align-items-center gap-2" href="./index.html">
            <img src="<?=base_url('dist')?>/assets/images/brand/logo/logo-icon.svg" class="img-fluid" alt="">
            <span class="fw-bold fs-4  site-logo-text">CNEL</span>
        </a>
    </div>
    <ul class="navbar-nav flex-column  ">
        ...
        <!-- Nav item -->
        <li class="nav-item">
            <a class="nav-link active" href="./index.html"><span class="nav-icon"><svg
        ...
        <!-- Nav item -->
        <li class="nav-item">
            <a class="nav-link position-relative " href="./pages/blank.html" aria-label="External Link">
                <span class="nav-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
                        class="icon icon-tabler icons-tabler-outline icon-tabler-file">
        ...
        <ul class="navbar-nav flex-column  ">
            ...
            <li class="nav-item">
                <a class="nav-link" href="./index.html"><span class="nav-icon"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        </svg> <span class="text">Project</span></span></a>
            </li>
            <!-- Nav item -->
            <li class="nav-item">
