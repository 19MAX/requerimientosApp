...
<div class="custom-container">
    <div class="row mb-6 align-items-center">
        <div class="col-xl-8 col-lg-6">
            <h1 class="fs-3 mb-0">Crear Documentos</h1>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <?php if ($doc['status'] === 'pendiente' && $doc['director_id'] === null): ?>

                                                        <li>
                                                            <button class="dropdown-item"
                                                                onclick="openAssignDirectorModal(<?= htmlspecialchars(json_encode($doc)) ?>)">
                                                    ...
                                                    <?php elseif ($doc['status'] === 'pendiente'): ?>
...
<script>
    ...
    // ── Asignar Director modal ─────────────────────────────────────
    function openAssignDirectorModal(doc) {
